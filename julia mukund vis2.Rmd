    ...
    if(varNames == ("age_group")){
      ...
      age_df %>%
        ...
        ggplot(aes(x = groups, y = age_count)) + 
          ...
          theme_minimal() + 
          scale_x_discrete(limits = c("age_under_5","age_5_to_10","age_11_to_20", "age_21_to_30","age_31_to_50",  "age_51_to_70", "age_over_71"),
                           labels = c("Age Under 5", "Age 5 to 10", "Age 11 to 20", "Age 21 to 30", "Age 31 to 50", "Age 51 to 70", "Age Over 71")) 
...
PreEventPlot(data,varNames = c("age_group"), title = "Age of All Participants at Event", "", "", "")
